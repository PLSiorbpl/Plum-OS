...
extern "C" void *malloc(const uint64_t size) {
...
extern "C" void* memcpy(void* dst, const void* src, const size_t size) {
...
extern "C" volatile void* memmove(volatile void* dst, volatile const void* src, const size_t size) {
...
extern "C" void* memset(void* dst, const uint8_t value, const size_t size) {
...
extern "C" bool memcmp(const void* src1, const void* src2, const size_t size) {
